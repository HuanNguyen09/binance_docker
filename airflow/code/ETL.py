...
class PathGenerator:
    ...
    def get_partition_time(self):
        ...
        # partition = f'year={now.year}/month={now.month}/day={22}'
        return partition
...
def getDataFromDataLake(self, table):
        ...
        '''
        path = PathGenerator(hdfs_host=self.host, hdfs_port=9000,database = "Binance_Data")
...
if __name__ == "__main__":
    ...
    path = PathGenerator(hdfs_host="hive-container", hdfs_port=9000,database = "Binance_Data")
